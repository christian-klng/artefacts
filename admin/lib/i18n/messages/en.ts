...
const en: Messages = {
  ...
  apps: {
    ...
    working: "Working …",
    confirmPublish: "Publish this app publicly now?",
    confirmUnpublish: "Take this app offline? It will no longer be reachable.",
    featuredHint: "Feature as a landmark on the landing page",
    errNotConfigured: "Publishing is not configured (ADMIN_API_SECRET missing).",
