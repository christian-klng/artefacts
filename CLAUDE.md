...
## Phase status
0 (auth/DB/Docker), 1 (agent + SSE), 2 (workspace UI) done and deployed. Next: Phase 3 = download standalone HTML + artifact version history; Phase 4 = multiple projects per user.
